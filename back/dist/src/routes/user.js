...
import { idSchema, UserCreateSchema, UserData, UserDelete, UserLoginSchema, UserRespGet, UsersGet, UserUpdateFirst, UserUpdateSchema } from '../schemas.js';
...
router.patch("/", async (req, res) => {
    ...
    if (mudarSenha) {
        if (!novasenha)
            ...
            novasenhaHash = await hashPassword(novasenha);
    }
    if (changeType && !tipo) {
...
router.get("/mainpageinfo", async (req, res) => {
